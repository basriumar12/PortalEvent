...
public class HiburanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_hiburan, container, false);
        progressBar = view.findViewById(R.id.progress_circulaar);
        recyclerView = view.findViewById(R.id.rv_categoriees);
    ...
    private void getData() {
        ...
        Call<ArrayList<ResponseCategories>> response = api.getBarangCategories("jenis-0004");
