...
public class CateringFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = view.findViewById(R.id.progreess_circular);
        recyclerView = view.findViewById(R.id.rv_cateegories);
    ...
    private void getData() {
        ...
        Call<ArrayList<ResponseCategories>> response = api.getBarangCategories("jenis-0002");
