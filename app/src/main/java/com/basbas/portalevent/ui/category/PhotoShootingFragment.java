...
public class PhotoShootingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_photo_shooting, container, false);
        progressBar = view.findViewById(R.id.progggress_circular);
        recyclerView = view.findViewById(R.id.rv_categggories);
    ...
    private void getData() {
        ...
        Call<ArrayList<ResponseCategories>> response = api.getBarangCategories("jenis-0003");
